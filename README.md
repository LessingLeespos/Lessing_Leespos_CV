...
## 🚀 About Me
Operations Data Analyst with 2+ years of experience building reports, dashboards, and driving data integrity. Equipped with SQL, Python, and cloud ecosystems (Azure/Fabric) to bridge the gap between complex backend data and actionable business strategy. Passionate about transforming chaotic data 'oceans' into clean, structured insights.
